# City / regional hero photo notes

Used on city scope pages (`/city/[slug]`) and regional category fallbacks via `NORTH_COAST_HERO_IMAGE`.
...
Exports are 1600×900 JPEGs for the city photo hero.
