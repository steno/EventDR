...
| Daily ~4:00 AST | `daily-today-spotlight.yml` → Facebook + Instagram happening-today (prefers today’s specials unless that channel already posted) | **spotlight today’s specials** for the manual specials post; **spotlight the top 3 today** matches the 08:00 UTC job |
