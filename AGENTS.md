...
| Daily ~4:00 AST | `daily-today-spotlight.yml` → Facebook + Instagram (all today’s specials when available, else top 3 happening-today) | **spotlight today’s specials** for the manual specials post; **spotlight the top 3 today** matches the 08:00 UTC job |
