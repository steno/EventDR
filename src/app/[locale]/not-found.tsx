...
export default async function NotFound() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-background dark:bg-transparent px-4 text-center">
      ...
      >
        {fillTemplate(dict.browse.backTo, { title: dict.nav.discover })}
      </Link>
    </main>
  );
}
