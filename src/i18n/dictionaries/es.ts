...
export const es: Dictionary = {
  ...
  browse: {
    ...
    eventsOnRegion: "Eventos en la {place}",
  ...
  events: {
    ...
    seeAllSpecials: "Ver todos los especiales",
    todaysSpecials: "Especiales de hoy",
    scrollSpecialsPrev: "Especiales anteriores",
  ...
  search: {
    ...
    nothingHereWhen: "¿Nada por aquí {when}?",
    nothingInArea: "¿Nada en {area}?",
    nothingInAreaWhen: "¿Nada en {area} {when}?",
    noCategory: "¿No hay {category} por ahora?",
    noCategoryWhen: "¿No hay {category} {when}?",
    noCategoryInArea: "¿No hay {category} en {area}?",
    noCategoryInAreaWhen: "¿No hay {category} en {area} {when}?",
    emptyWhen: {
      today: "hoy",
      tomorrow: "mañana",
      weekend: "este finde",
    },
    tryTheseDays: "Prueba estos días",
  ...
  detail: {
    ...
    remindVia: "Recordarme",
    remindDayBefore: "El día anterior",
    remindDayBeforeHint: "10:00 a. m.",
    remindMorningOf: "En la mañana",
    remindMorningOfHint: "10:00 a. m.",
    remindTwoHours: "2 horas antes",
    remindTwoHoursHint: "Antes de que empiece",
    remindRecommended: "Ideal",
    ...
    remindNeedPermission: "Notificaciones bloqueadas — actívalas en Ajustes e inténtalo de nuevo",
    remindNeedHomeScreen: "En iPhone, abre POP Events desde el icono en la pantalla de inicio para activar recordatorios",
    ...
    lineup: "Artistas",
    participants: "Locales participantes",
    participantsDirectory: "Ver lista completa",
  ...
  cruise: {
    ...
    routeUnavailable:
      "El mapa no está disponible ahora — usa la lista de paradas abajo.",
    loopMetaTitle: "{loop} desde {port} | POP Events",
    loopMetaDescription:
      "{body} Mira el circuito desde el barco antes de dejar el muelle.",
  ...
  cities: {
    ...
    lookingOnRegionWithCategory: "Eventos de {category} en la",
  ...
  venues: {
    ...
    routeError: "No se pudo trazar la ruta. Prueba un punto de partida más claro.",
