...
export const fr: Dictionary = {
  ...
  browse: {
    ...
    eventsOnRegion: "Événements sur la {place}",
  ...
  search: {
    ...
    nothingHereWhen: "Rien ici {when} ?",
    nothingInArea: "Rien à {area} ?",
    nothingInAreaWhen: "Rien à {area} {when} ?",
    noCategory: "Pas de {category} pour l'instant ?",
    noCategoryWhen: "Pas de {category} {when} ?",
    noCategoryInArea: "Pas de {category} à {area} ?",
    noCategoryInAreaWhen: "Pas de {category} à {area} {when} ?",
    emptyWhen: {
      today: "aujourd'hui",
      tomorrow: "demain",
      weekend: "ce week-end",
    },
    tryTheseDays: "Essayez ces jours",
  ...
  detail: {
    ...
    remindVia: "Me rappeler",
    remindDayBefore: "La veille",
    remindDayBeforeHint: "10 h 00",
    remindMorningOf: "Le matin même",
    remindMorningOfHint: "10 h 00",
    remindTwoHours: "2 heures avant",
    remindTwoHoursHint: "Avant le début",
    remindRecommended: "Idéal",
    remindCancel: "Annuler le rappel",
    remindSet: "Rappel programmé !",
    remindTooLate: "Cet événement est trop proche pour un rappel.",
    remindNeedPermission: "Notifications bloquées — autorisez-les dans Réglages, puis réessayez",
    remindNeedHomeScreen: "Sur iPhone, ouvrez POP Events depuis l’icône sur l’écran d’accueil pour activer les rappels",
  ...
  cities: {
    ...
    lookingOnRegionWithCategory: "Événements {category} sur la",
  ...
  venues: {
    ...
    routeError: "Impossible de tracer la route. Essayez un départ plus précis.",
