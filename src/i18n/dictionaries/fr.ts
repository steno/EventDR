...
export const fr: Dictionary = {
  ...
  events: {
    ...
    yourEventHereTitle: "Vous organisez quelque chose ?",
  ...
  venues: {
    ...
    streetViewLoading: "Chargement de Street view…",
    streetViewUnavailable: "Street view n'est pas disponible ici.",
    streetViewError: "Impossible de charger Street view.",
    website: "Site web",
    instagram: "Instagram",
