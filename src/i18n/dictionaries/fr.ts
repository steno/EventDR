...
export const fr: Dictionary = {
  ...
  events: {
    ...
    audienceTitle: "Événements en vedette",
    local: "Favoris locaux",
    visitor: "Favoris des visiteurs",
    localHint: "Événements adorés des locaux sur la Côte Nord",
    visitorHint: "Expériences incontournables pour touristes et visiteurs",
