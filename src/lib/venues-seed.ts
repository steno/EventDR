...
export const SEED_VENUES: Venue[] = [
  ...
  },
  {
    ...
    city: "Sosúa",
    description:
      "Expat-owned sports pub on Calle Pedro Clisante — rock and blues cover bands, big-screen sports, pub food, Mandarin Mondays Chinese takeout from 3 PM, Fire & Ice Thursdays pizza-and-beer combo, and a steady weekly live-music crowd.",
    lat: 19.7678473,
    lng: -70.5103493,
    emoji: "🍻",
    phone: "+1809404822463",
  ...
  // Restaurant Week Puerto Plata 2026 participants.
  {
    slug: "aguaji-sosua",
    name: "Aguají",
    city: "Sosúa",
    description:
      "Chef Tita’s Dominican alta cocina at The Ocean Club (Luxury Collection), Calle Bruno Philip No. 5 — tasting menus rooted in Taíno-criollo flavors with bay views. Dinner Fri–Sun 6–10 PM; reservations essential.",
    lat: 19.7691248,
    lng: -70.5168106,
    emoji: "🍽️",
    instagram: "aguaji.altacocina",
    phone: "+18098778726",
    googleRating: 4.2,
  ...
  {
    slug: "baia-lounge-sosua",
    name: "Baia Lounge",
    city: "Sosúa",
    description:
      "All-day international lounge-restaurant at The Ocean Club Costa Norte — Mediterranean seafood, sushi, wood-fired pizza, and sunset cocktails on Calle Bruno Philip. Open breakfast through dinner.",
    lat: 19.76905,
    lng: -70.51675,
    emoji: "🍸",
    instagram: "baialoungedr",
    phone: "+18098956000",
  },
  {
    slug: "bliss-cabarete",
    ...
    city: "Cabarete",
    description:
      "Italian-Mediterranean dinner house on Callejón Máximo in La Ciénaga — homemade pasta, local fish, US Angus steaks, and a wide Italian wine list. Dinner Mon–Sat 6:00–10:30 PM; closed Sunday.",
    lat: 19.7645862,
    lng: -70.4291017,
    emoji: "🍝",
    instagram: "blisscabarete",
    website: "https://restaurantebliss.com/",
    phone: "+18297017215",
    googleRating: 4.7,
    googleRatingFetchedAt: "2026-09-07T00:00:00.000Z",
  },
  {
    slug: "casa-balcon-puerto-plata",
    name: "Casa Balcón",
    city: "Puerto Plata",
    description:
      "International kitchen on a balcony overlooking Plaza Independencia — cocktail nights and set menus with gazebo views in Puerto Plata centro.",
    lat: 19.79725,
    lng: -70.69295,
    emoji: "🍽️",
    instagram: "casabalconrd",
    phone: "+18093816676",
  },
  {
    slug: "casa-caribe-puerto-plata",
    name: "Casa Caribe",
    city: "Puerto Plata",
    description:
  ...
  },
  {
    ...
    city: "Puerto Plata",
    description:
      "Caribbean-fusion dining in an 1879 Victorian house at Calle Beller #40 facing Plaza Independencia — seafood, meats, and plaza views in the historic center.",
    lat: 19.79735,
    lng: -70.69305,
    emoji: "🍽️",
    instagram: "lacaditaazulpop",
    phone: "+18095863718",
    website: "https://puertoplatadr.com/restaurants/la-casita-azul/",
  },
  {
    ...
    city: "Puerto Plata",
    description:
      "Caribbean-fusion kitchen in a restored Victorian house in Puerto Plata’s historic district — live piano evenings, seafood, and creative island plates.",
    lat: 19.7969,
    lng: -70.69415,
    emoji: "🍽️",
    instagram: "laisabelapop",
    phone: "+18096977989",
    website: "https://puertoplatadr.com/restaurants/la-isabela-restaurant/",
  },
  {
    slug: "la-lola-malecon",
    name: "La Lola Beach Club",
    city: "Puerto Plata",
    description:
      "Open-air beach-club dining on Avenida Gregorio Luperón (Malecón) — casual Caribbean-Mediterranean plates with Atlantic views from breakfast through late evening.",
    lat: 19.7969,
    lng: -70.68725,
    emoji: "🌊",
    instagram: "Lalolabeachclub",
    phone: "+18495175705",
  },
  {
    ...
    city: "Cabarete",
    description:
      "Beachfront Latin-Asian kitchen on Cabarete Bay — wok classics, sushi, ceviche, and sand tables under lanterns.",
    lat: 19.75035,
    lng: -70.40705,
    emoji: "🍜",
  ...
  },
  {
    ...
    city: "Puerto Plata",
    description:
      "Italian-leaning kitchen at Plaza Juan Brugal / Av. Circunvalación Sur (Carretera Luperón Km 1, local 7) — pizza, pasta, and plated dinners on the city’s south ring, not out toward Playa Dorada.",
    lat: 19.78805,
    lng: -70.69455,
    emoji: "🍽️",
    instagram: "maurospop",
  ...
  {
    slug: "mi-bodegon-cabarete",
    name: "Mi Bodegón Cabarete",
    city: "Cabarete",
    description:
      "Argentine bodegón at Plaza Ocean Dream on Cabarete’s Carretera Principal — grilled cuts, empanadas, milanesas, and Argentine wines. Mon–Sat 11:30 AM–11:00 PM; closed Sunday.",
    lat: 19.7509018,
    lng: -70.4147976,
    emoji: "🥩",
    instagram: "mibodegoncabarete",
    website: "https://mibodegoncabarete.com/",
    phone: "+18099649916",
    googleRating: 4.6,
    googleRatingFetchedAt: "2026-09-07T00:00:00.000Z",
  },
  {
    ...
    city: "Puerto Plata",
    description:
      "Countryside ranch dining in El Cupey — parrilla, local produce, mountain views, and a family-friendly open-air estate. Reservations recommended on Sundays.",
    lat: 19.7371866,
    lng: -70.7253286,
    emoji: "🥩",
    instagram: "rancholacatalina",
    phone: "+18097813737",
    googleRating: 4.7,
  ...
  {
    slug: "ristorante-passatore-playa-dorada",
    name: "Ristorante Passatore",
    city: "Playa Dorada",
    description:
      "Italian patio restaurant at Playa Dorada Plaza — handmade pasta, wood-fired pizza, seafood, and an outdoor pergola dining room in the resort complex.",
    lat: 19.7704077,
    lng: -70.6426997,
    emoji: "🍕",
    instagram: "ristorantepassatore",
    website: "https://www.ristorantepassatore.com/",
    phone: "+18093201722",
    googleRating: 4.6,
    googleRatingFetchedAt: "2026-09-07T00:00:00.000Z",
  },
  {
    slug: "sambalu-puerto-plata",
    name: "Sambalú Restaurant",
    city: "Puerto Plata",
    description:
      "Caribbean restaurant at José del Carmen Ariza #35 (corner Duarte) — two levels with a cathedral-view terrace in the historic center.",
    lat: 19.79795,
    lng: -70.69345,
    emoji: "🍽️",
    instagram: "Sambalu.rd",
    phone: "+18099594771",
    website: "https://puertoplatadr.com/restaurants/sambalu-restaurant/",
  },
  {
    slug: "skina-puerto-plata",
    name: "Skina",
    city: "Puerto Plata",
    description:
      "Dominican and Caribbean kitchen at Calle Separación & 12 de Julio — rustic patio feel in the historic center, known for sancocho and family tables.",
    lat: 19.79755,
    lng: -70.69385,
    emoji: "🍽️",
    instagram: "skinarestaurant",
    phone: "+18099701950",
  },
  {
    slug: "sun-club-costa-norte-sosua",
    name: "Sun Club Costa Norte",
    city: "Sosúa",
    description:
      "Veuve Clicquot beach club at The Ocean Club Costa Norte — yellow-stripe loungers, cabanas, and charcoal seafood on the resort pool deck. Calle Bruno Philip.",
    lat: 19.76925,
    lng: -70.51645,
    emoji: "☀️",
...
const VENUE_ALIASES: { pattern: RegExp; slug: string }[] = [
  ...
  {
    pattern:
      /green\s*jack|blue\s*jack\s*tar|blue\s*jacktar/i,
    slug: "blue-jacktar-playa-dorada",
  },
  { pattern: /^aguaj[ií]$|aguaji\s*(alta\s*cocina)?/i, slug: "aguaji-sosua" },
  { pattern: /^baia$|baia\s*lounge/i, slug: "baia-lounge-sosua" },
  ...
  { pattern: /^mauros$/i, slug: "mauros-puerto-plata" },
  {
    pattern: /mi\s*bodeg[oó]n|bodeg[oó]n\s*cabarete/i,
    slug: "mi-bodegon-cabarete",
  },
  {
    pattern: /rancho\s*(la\s*)?catalina/i,
    slug: "rancho-catalina-puerto-plata",
  },
  {
    pattern: /passatore|ristorante\s*passatore/i,
    slug: "ristorante-passatore-playa-dorada",
  },
  { pattern: /sambal[uú]/i, slug: "sambalu-puerto-plata" },
  { pattern: /^skina$/i, slug: "skina-puerto-plata" },
  {
    pattern: /sun\s*club\s*costa\s*norte|veuve\s*clicquot/i,
    slug: "sun-club-costa-norte-sosua",
  },
  {
