...
export const SEED_VENUES: Venue[] = [
  ...
  // Restaurant Week Puerto Plata 2026 participants — profiles without curated photos yet.
  {
    slug: "aguaji-sosua",
    name: "Aguaji",
    city: "Sosúa",
    description:
      "Dominican alta cocina in El Batey on Calle Bruno Philips — contemporary criollo plates in Sosúa’s walkable dining pocket. Restaurant Week RD participant.",
    lat: 19.768382,
    lng: -70.516328,
    emoji: "🍽️",
  ...
  },
  {
    ...
    city: "Sosúa",
    description:
      "International lounge-restaurant on Calle Bruno Philips in El Batey — same Sosúa dining pocket as Aguaji. Restaurant Week RD participant.",
    lat: 19.76835,
    lng: -70.51628,
    emoji: "🍸",
  ...
  },
  {
    ...
    city: "Cabarete",
    description:
      "Italian-Mediterranean dinner restaurant in La Ciénaga / Callejón Máximo, Cabarete — homemade pasta, local fish, and a poolside courtyard. Dinner Mon–Sat; Restaurant Week RD participant.",
    lat: 19.7482,
    lng: -70.4145,
    emoji: "🍝",
  ...
  },
  {
    ...
    city: "Puerto Plata",
    description:
      "International kitchen at Plaza Paseo del Parque on Calle Separación — Restaurant Week RD participant in Puerto Plata.",
    lat: 19.7972,
    lng: -70.6928,
    emoji: "🍽️",
  ...
  },
  {
    ...
    city: "Puerto Plata",
    description:
      "International restaurant on Ave. Luis Ginebra in Puerto Plata centro — Restaurant Week RD participant.",
    lat: 19.7948,
    lng: -70.6945,
    emoji: "🍽️",
  ...
  },
  {
    ...
    city: "Puerto Plata",
    description:
      "International restaurant on Calle Beller at Plaza Independencia in the historic center — Restaurant Week RD participant.",
    lat: 19.7975,
    lng: -70.6931,
    emoji: "🍽️",
  ...
  },
  {
    ...
    city: "Puerto Plata",
    description:
      "International restaurant near Profesor Juan Bosch & Eugenio Deschamps in Puerto Plata — Restaurant Week RD participant.",
    lat: 19.7965,
    lng: -70.694,
    emoji: "🍽️",
  ...
  },
  {
    ...
    city: "Puerto Plata",
    description:
      "Beach-club dining on Avenida el Malecón in Puerto Plata — international plates on the waterfront strip. Restaurant Week RD participant.",
    lat: 19.7972,
    lng: -70.6882,
    emoji: "🌊",
  ...
  },
  {
    ...
    city: "Puerto Plata",
    description:
      "Latin-Asian fusion on Avenida Luis Ginebra (Plaza 1), Puerto Plata — Restaurant Week RD participant.",
    lat: 19.7945,
    lng: -70.6942,
    emoji: "🍜",
  ...
  },
  {
    ...
    city: "Puerto Plata",
    description:
      "International restaurant at Plaza Juan Brugal on the Puerto Plata–Sosúa corridor (Km 1) — Restaurant Week RD participant.",
    lat: 19.7855,
    lng: -70.62,
    emoji: "🍽️",
    instagram: "maurospop",
  ...
  },
  {
    ...
    city: "Cabarete",
    description:
      "Argentine restaurant at Plaza Ocean Dream on Cabarete’s Calle Principal — steaks, wines, and porteño tables. Restaurant Week RD participant.",
    lat: 19.7506,
    lng: -70.4082,
    emoji: "🥩",
  ...
  },
  {
    ...
    name: "Rancho Catalina",
    city: "Puerto Plata",
    description:
      "Meats-and-grill ranch dining in El Cupey, Puerto Plata — open-air parrilla experience. Restaurant Week RD participant.",
    lat: 19.7371866,
    lng: -70.7253286,
    emoji: "🥩",
    instagram: "ranchocatalina",
    phone: "+18097813737",
  },
  {
    ...
    city: "Playa Dorada",
    description:
      "Italian pizza and pasta at Playa Dorada Plaza — Restaurant Week RD participant inside the resort complex.",
    lat: 19.7699,
    lng: -70.6425,
    emoji: "🍕",
  ...
  },
  {
    ...
    city: "Puerto Plata",
    description:
      "International restaurant on Calle José Del Carmen Ariza in Puerto Plata — Restaurant Week RD participant.",
    lat: 19.7984235,
    lng: -70.6931832,
    emoji: "🍽️",
  ...
  },
  {
    ...
    city: "Puerto Plata",
    description:
      "International restaurant at Calle Separación & 12 de Julio in Puerto Plata centro — Restaurant Week RD participant.",
    lat: 19.7978,
    lng: -70.6935,
    emoji: "🍽️",
  ...
  },
  {
    ...
    city: "Sosúa",
    description:
      "Beach-club dining on Calle Bruno Philips in El Batey (Veuve Clicquot partnership) — Restaurant Week RD participant.",
    lat: 19.7683,
    lng: -70.5164,
    emoji: "☀️",
...
const VENUE_ALIASES: { pattern: RegExp; slug: string }[] = [
  ...
  { pattern: /latinwok|latin\s*wok/i, slug: "latinwok-puerto-plata" },
