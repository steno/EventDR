...
const KEYWORDS: KeywordMap = {
  ...
  music: [
    ...
    // Genre phrases only — bare típico/typique collides with “typical”
    // adjectives (Horarios típicos, Budget typique, Créneaux typiques).
    { term: "música típica", weight: 2 },
    { term: "musica tipica", weight: 2 },
    { term: "musique typique", weight: 2 },
    { term: "live típico", weight: 2 },
    { term: "live tipico", weight: 2 },
    { term: "típico live", weight: 2 },
    { term: "tipico live", weight: 2 },
    { term: "accordion típico", weight: 2 },
    { term: "acordeón típico", weight: 2 },
    { term: "acordeon tipico", weight: 2 },
    { term: "domingo típico", weight: 2 },
    { term: "domingo tipico", weight: 2 },
    { term: "grupo típico", weight: 2 },
    { term: "grupo tipico", weight: 2 },
  ...
  business: [
    ...
    { term: "business rounds", weight: 2 },
    { term: "trade fair", weight: 2 },
    { term: "trade show", weight: 2 },
    { term: "feria de negocios", weight: 2 },
    { term: "rueda de negocios", weight: 2 },
    { term: "ruedas de negocios", weight: 2 },
    { term: "salon professionnel", weight: 2 },
    { term: "rendez-vous d'affaires", weight: 2 },
    { term: "b2b", weight: 2 },
    { term: "congreso", weight: 2 },
    "business",
    "negocio",
    "affaires",
    "meetup",
