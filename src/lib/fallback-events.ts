...
const FALLBACK_EVENTS_EN: Event[] = [
  ...
  {
    id: "groundzero-viernes-locos",
    title: "Viernes Locos at Ground Zero",
    description:
      "Crazy Fridays at Ground Zero Discoteca — whisky half-price and a late Sosúa party night on the Puerto Plata–Sosúa highway opposite the airport. Reserve a table: 849-465-1313.",
    date: "2026-08-07",
    location: "Sosúa",
    venue: "Ground Zero Discoteca",
    venueSlug: "ground-zero-disco",
    ...
    sourceUrl: "https://www.instagram.com/groundzero_disco/p/DbclfDnuf2U/",
    imageEmoji: "🪩",
  },
  {
    id: "groundzero-party-rojo-2026-08-01",
    title: "Party Rojo at Ground Zero",
    description:
      "Ground Zero presents Party Rojo — Saturday Aug 1 red-dress theme night on the Puerto Plata–Sosúa highway opposite the airport. First 25 women in a red dress enter free; call for cover and table reservations: 849-465-1313.",
    date: "2026-08-01",
    location: "Sosúa",
    venue: "Ground Zero Discoteca",
    venueSlug: "ground-zero-disco",
    ...
    trending: true,
    sourceType: "instagram",
    sourceUrl: "https://www.instagram.com/groundzero_disco/p/DbTqSiPPq35/",
    imageEmoji: "🔴",
  },
  {
  ...
  {
    id: "chill-and-grill-bingo-2026-08-03",
    title: "Bingo Night at Chill & Grill",
    description:
      "Bingo tonight at Chill & Grill Bar & Eatery in Casa Linda (Sosúa) — Monday Aug 3 from 6:30 PM. Community tip from Everything Sosúa; message the venue on WhatsApp to confirm cards and cover.",
    date: "2026-08-03",
    time: "6:30 PM",
    location: "Sosúa",
    venue: "Chill & Grill Bar & Eatery",
    venueSlug: "castaways-sosua",
    address: "Casa Linda Villas Phase 7-9, Carretera El Choco, Sosúa 57000",
    lat: 19.7643646,
    lng: -70.4890209,
    category: "food-drinks",
    categories: ["culture"],
    ...
    sourceUrl:
      "https://www.facebook.com/groups/everythingsosua/permalink/28014195504863696/",
    imageEmoji: "🎱",
  },
  {
    id: "cigar-town-acustico-humos-2026-08-14",
    title: "Cigar Town Sessions — Acústico & Humos",
    description:
      "Live acoustic night at Cigar Town Pop in Puerto Plata — Eddy Almonte and Café Meclao for Cigar Town Sessions: Acústico & Humos. Friday Aug 14 at Av. Luis Ginebra No. 56. Confirm start time with the lounge via Instagram @cigartownpop.",
    date: "2026-08-14",
    location: "Puerto Plata",
    venue: "Cigar Town Pop",
    venueSlug: "cigar-town-pop",
    address: "Avenida Luis Ginebra No. 56, Puerto Plata",
    lat: 19.7915,
    lng: -70.6805,
    category: "performances",
    categories: ["music"],
    format: "physical",
    callForPricing: true,
    lineup: ["Eddy Almonte", "Café Meclao"],
    sourceType: "instagram",
    sourceUrl: "https://www.instagram.com/p/DbgNSXyxhGQ/",
    imageEmoji: "🎸",
  },
  {
    id: "congreso-damas-adn-2026",
    title: "Congreso de Damas ADN 2026 — Mujer, Vive sin Temor",
    description:
      "Women's congress of the Asociación Dominicana del Norte (ADN / Ministerio de la Mujer ADN) at all-inclusive Gran Ventana Beach Resort in Playa Dorada — Oct 2–4 under the theme “Mujer, Vive sin Temor / Bajo el manto de Su gracia.” Registration RD$2,000 (limited capacity); room packages from RD$13,200–16,900 per person. ADN offices: +1 809 582 6688; Directora MM Nancy Vera: +1 809 501 5074.",
    date: "2026-10-02",
    endDate: "2026-10-04",
    time: "3:00 PM – 12:00 PM",
    location: "Playa Dorada",
    venue: "Gran Ventana Beach Resort",
    venueSlug: "gran-ventana-beach-resort",
    address: "Complejo Hotelero Playa Dorada, Puerto Plata 57000",
    lat: 19.7723664,
    lng: -70.6402715,
    category: "business",
    categories: ["culture"],
    ...
    phone: "+18095826688",
    sourceUrl: "https://www.facebook.com/events/2570492776681289/",
    imageEmoji: "💜",
  },
];
...
const FALLBACK_EVENTS_ES: Event[] = [
  ...
  {
    id: "groundzero-viernes-locos",
    title: "Viernes Locos en Ground Zero",
    description:
      "Viernes Locos en Ground Zero Discoteca — whiskys a mitad de precio y fiesta hasta tarde en la carretera Puerto Plata–Sosúa frente al aeropuerto. Reserva mesa: 849-465-1313.",
    date: "2026-08-07",
    location: "Sosúa",
    venue: "Ground Zero Discoteca",
    venueSlug: "ground-zero-disco",
  ...
  {
    id: "groundzero-party-rojo-2026-08-01",
    title: "Party Rojo en Ground Zero",
    description:
      "Ground Zero presenta Party Rojo — sábado 1 ago., noche de vestido rojo en la carretera Puerto Plata–Sosúa frente al aeropuerto. Las primeras 25 mujeres con vestido rojo entran gratis; consulta cover y reserva mesa: 849-465-1313.",
    date: "2026-08-01",
    location: "Sosúa",
    venue: "Ground Zero Discoteca",
    venueSlug: "ground-zero-disco",
  ...
  {
    id: "chill-and-grill-bingo-2026-08-03",
    title: "Bingo en Chill & Grill",
    description:
      "Bingo esta noche en Chill & Grill Bar & Eatery en Casa Linda (Sosúa) — lunes 3 de agosto desde las 6:30 PM. Tip comunitario de Everything Sosúa; escribe por WhatsApp al local para confirmar cartones y cover.",
    date: "2026-08-03",
    time: "6:30 PM",
    location: "Sosúa",
    venue: "Chill & Grill Bar & Eatery",
  ...
  },
  {
    ...
    title: "Cigar Town Sessions — Acústico & Humos",
    description:
      "Noche acústica en vivo en Cigar Town Pop, Puerto Plata — Eddy Almonte y Café Meclao para Cigar Town Sessions: Acústico & Humos. Viernes 14 de agosto en Av. Luis Ginebra No. 56. Confirma la hora por Instagram @cigartownpop.",
    date: "2026-08-14",
    location: "Puerto Plata",
    venue: "Cigar Town Pop",
    venueSlug: "cigar-town-pop",
  ...
  },
  {
    ...
    title: "Congreso de Damas ADN 2026 — Mujer, Vive sin Temor",
    description:
      "Congreso de damas de la Asociación Dominicana del Norte (ADN / Ministerio de la Mujer ADN) en el Gran Ventana Beach Resort todo incluido de Playa Dorada — del 2 al 4 de octubre bajo el lema “Mujer, Vive sin Temor / Bajo el manto de Su gracia.” Inscripción RD$2,000 (cupo limitado); habitaciones desde RD$13,200–16,900 por persona. Oficinas ADN: +1 809 582 6688; Directora MM Nancy Vera: +1 809 501 5074.",
    date: "2026-10-02",
    endDate: "2026-10-04",
    time: "3:00 PM – 12:00 PM",
    location: "Playa Dorada",
