...
export const FALLBACK_EVENTS_FR: Event[] = [
  ...
  },
  {
    ...
    title: "Viernes Locos au Ground Zero",
    description:
      "Vendredi fous au Ground Zero Discoteca — whisky à moitié prix et soirée tardive sur la route Puerto Plata–Sosúa face à l'aéroport. Réservez une table : 849-465-1313.",
    date: "2026-08-07",
    location: "Sosúa",
    venue: "Ground Zero Discoteca",
    venueSlug: "ground-zero-disco",
  ...
  },
  {
    ...
    title: "Party Rojo au Ground Zero",
    description:
      "Ground Zero présente Party Rojo — samedi 1er août, soirée robe rouge sur la route Puerto Plata–Sosúa face à l'aéroport. Les 25 premières femmes en robe rouge entrent gratuitement ; cover et réservation de table : 849-465-1313.",
    date: "2026-08-01",
    location: "Sosúa",
    venue: "Ground Zero Discoteca",
    venueSlug: "ground-zero-disco",
  ...
  },
  {
    ...
    description:
      "Course 5K immersive sur le Malecón de Puerto Plata avec casques synchronisés à un DJ live — organisée par Aleva Experiences. RDV à Victrola 037 Arte Café ; neon after-party, tombolas et prix après la course. Billets dès RD$950 sur boletu.com (phases épuisées — liste d'attente).",
    date: "2026-07-25",
    time: "6:00 AM",
    location: "Puerto Plata",
  ...
  },
  {
    ...
    title: "Sunset Night Party — Un événement, deux expériences",
    description:
      "Fête plage du coucher de soleil jusqu'à tard chez Bonsai Poke, Playa Encuentro, Cabarete — samedi 25 juil. Session sunset 17 h–21 h ; night party dès 21 h avec HYPER, ALDENKINGS et TAÏF. Early bird RD$500 (welcome drink ; 70 billets). Produit par SONIK Productions ; accueille aussi les athlètes Surf, Longboard et SUP des Jeux CAC 2026. Billets sur tix.do.",
    date: "2026-07-25",
    time: "17 h – tard",
    location: "Cabarete",
  ...
  },
  {
    ...
    description:
      "Fête de plusieurs jours pour le Labor Day 2026 par Trilogy World au VIP Beach Lifestyles Resort and Spa (Cofresí) — 3–7 sept. DJs et nightlife du groupe new-yorkais pour le week-end férié sur la côte ouest de Puerto Plata.",
    date: "2026-09-03",
    endDate: "2026-09-07",
  ...
  },
  {
    ...
    description:
      "Reina (Dominicated) anime un club de rire de 30 minutes sur la plage de Cabarete — mardis dès le 28 juil. à 18 h 30. RDV à l'entrée plage d'Ocean One au cœur de Cabarete ; apportez de l'eau et portez des vêtements confortables.",
    date: "2026-07-28",
  ...
  },
  {
    ...
    title: "Bingo au Chill & Grill",
    description:
      "Bingo ce soir au Chill & Grill Bar & Eatery à Casa Linda (Sosúa) — lundi 3 août dès 18 h 30. Tuyau communautaire d'Everything Sosúa ; écrivez au local sur WhatsApp pour confirmer cartons et entrée.",
    date: "2026-08-03",
    time: "6:30 PM",
    location: "Sosúa",
  ...
  },
  {
    ...
    description:
      "Soirée acoustique live à Cigar Town Pop, Puerto Plata — Eddy Almonte et Café Meclao pour Cigar Town Sessions : Acústico & Humos. Vendredi 14 août, Av. Luis Ginebra n° 56. Confirmez l'heure via Instagram @cigartownpop.",
    date: "2026-08-14",
    location: "Puerto Plata",
  ...
  },
  {
    ...
    description:
      "Congrès des femmes de l'Asociación Dominicana del Norte (ADN / Ministerio de la Mujer ADN) au Gran Ventana Beach Resort tout compris à Playa Dorada — du 2 au 4 octobre sous le thème « Mujer, Vive sin Temor / Bajo el manto de Su gracia ». Inscription RD$2,000 (places limitées) ; chambres de RD$13,200 à 16,900 par personne. Bureaux ADN : +1 809 582 6688 ; Directora MM Nancy Vera : +1 809 501 5074.",
    date: "2026-10-02",
    endDate: "2026-10-04",
