 ...
 * Live and ending-soon events surface before future dates; ended-today sink last.
 */
const LIST_TIER = {
  endingSoon: 0,
  live: 1,
...
/** Status-aware list order: live & ending soon first, then soonest upcoming, ended today last. */
