...
export function SupportNudge({ locale, dict }: SupportNudgeProps) {
  ...
  return (
    ...
    >
      <div className="pointer-events-auto flex w-full max-w-lg items-start gap-3 rounded-2xl border border-orange-200/80 bg-white/95 p-3.5 shadow-[0_18px_50px_-28px_rgba(0,0,0,0.55)] backdrop-blur-md animate-in slide-in-from-bottom duration-300 dark:border-orange-900/50 dark:bg-neutral-950/95 sm:max-w-md">
        <span
