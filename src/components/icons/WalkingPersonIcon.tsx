...
/**
 * Classic “directions walk” silhouette (Material / Maps style).
 * Lucide has no mid-stride walk glyph; stroke stick figures read poorly at 12px.
 */
