...
const backControlClassName =
  "inline-flex items-center gap-2 text-[15px] font-semibold text-neutral-500 dark:text-neutral-400 hover:text-neutral-800 dark:hover:text-neutral-200 touch-manipulation";
